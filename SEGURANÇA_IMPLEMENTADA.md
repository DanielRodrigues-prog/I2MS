...
|---|----------|---------|--------|--------|
| 1️⃣ | SQL Injection | Parâmetros SQL (@id, @valor) | CRÍTICO | ✅ RESOLVIDO |
| 2️⃣ | Senha Hardcoded | Variáveis de Ambiente | CRÍTICO | ✅ RESOLVIDO |
| 3️⃣ | Validação Fraca | Validação de Entrada | ALTO | ✅ RESOLVIDO |
